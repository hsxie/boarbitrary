...
[vz,vx]=ndgrid((-12*vtz:dvz:12*vtz)+vdz,0:dvx:12*vtx); % (vpara,vperp) grid
...
elseif(icase==5) % slowing down, 24-12-22 14:00
...
xlabel('v_z');ylabel('v_x');
subplot(224);
contour(vz,vx,log(fv),150); colorbar;
xlabel('v_z');ylabel('v_x');