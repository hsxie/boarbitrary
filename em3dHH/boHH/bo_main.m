...
% 21-09-18 16:12 fixed a bug for imethod=1 in em3d_matrix.m
% 24-12-19 reduced, remove vdx,vdy,collision,unmagnetized and loss cone
% 24-12-21 rewrite to arbitrary case
% 24-12-22 07:40 test ok

close all;
clear; clc;

% % set initial parameters in 'bo.in' and 'bo_setup.m'
disp(['***** THIS IS PLASMA DISPERSION RELATION SOLVER BO-Arbitray V250110 *****',...
   10,'**** Support Arbitrary Distributions with Hermite-Hermite Expansion *****']);
tic; runtime=0;
